                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('store') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <textarea class="form-control @error('follow') is-invalid @enderror" name="follow" row="5" required autofocus>{{ $follow }}</textarea>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <textarea class="form-control @error('location') is-invalid @enderror" name="location" row="5" required autofocus>{{ $location }}</textarea>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <textarea class="form-control @error('location_button') is-invalid @enderror" name="location_button" row="5" required autofocus>{{ $location_button }}</textarea>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <textarea class="form-control @error('stamp') is-invalid @enderror" name="stamp" row="5" required autofocus>{{ $stamp }}</textarea>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <textarea class="form-control @error('not_found') is-invalid @enderror" name="not_found" row="5" required autofocus>{{ $not_found }}</textarea>
